...
import { MapView, Circle } from 'expo-maps';
...
// Círculo animado de propagación para expo-maps
const AnimatedPropagationCircle = ({ center, animatedRadius, animatedOpacity }) => {
